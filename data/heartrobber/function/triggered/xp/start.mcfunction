...
execute as @s[nbt=!{SelectedItem:{components:{"minecraft:custom_data":{"heartrobber:type":9b}}}},scores={heartrobber_compare=1..}] if data entity @s {equipment:{offhand:{components:{"minecraft:custom_data":{"heartrobber:type":9b}}}}} run function heartrobber:triggered/xp/store
