...
execute store result entity @s Motion[0] double -0.00001 run data get entity @s Motion[0] 50000
execute store result entity @s Motion[2] double -0.00001 run data get entity @s Motion[2] 50000
