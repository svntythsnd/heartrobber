execute unless block ~ ~ ~ air unless block ~ ~ ~ #heartrobber:closes_endpoint run return run function heartrobber:triggered/mail/endpoint/destroy with entity @s data
