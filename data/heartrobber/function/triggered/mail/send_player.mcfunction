...
data modify storage heartrobber:mail temp leading_rec_char set string heartrobber:mail temp.recipient 0 1
execute unless data storage heartrobber:mail temp{leading_rec_char:"$"} run return 0
data modify storage heartrobber:mail temp truncated_recipient set string heartrobber:mail temp.recipient 1
