...
execute if data entity @s {respawn:{dimension:"minecraft:overworld"}} if data entity @s respawn.pos[0] store result storage heartrobber:geolocator rx int 0.125 run data get entity @s respawn.pos[0]
...
execute if data entity @s {respawn:{dimension:"minecraft:the_end"}} run data modify storage heartrobber:geolocator rx set value "-"
execute unless data entity @s respawn.pos[0] run data modify storage heartrobber:geolocator rx set value "-"
...
execute if data entity @s {respawn:{dimension:"minecraft:overworld"}} if data entity @s respawn.pos[2] store result storage heartrobber:geolocator rz int 0.125 run data get entity @s respawn.pos[2]
...
execute if data entity @s {respawn:{dimension:"minecraft:the_end"}} run data modify storage heartrobber:geolocator rz set value "-"
execute unless data entity @s respawn.pos[2] run data modify storage heartrobber:geolocator rz set value "-"
