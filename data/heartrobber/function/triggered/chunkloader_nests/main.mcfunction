execute if block ~ ~ ~ glass align xyz positioned ~0.5 ~0.5 ~0.5 unless entity @n[type=item_display,tag=heartrobber_chunkloaderBlock,distance=..0.01] run summon item_display ~ ~ ~ {Tags:["heartrobber_chunkloaderBlock"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[1.0001f,1.0001f,1.0001f],translation:[0f,0f,0f]},item:{id:filled_map,components:{"minecraft:item_model":"heartrobber:chunkloader"}},view_range:2f}
