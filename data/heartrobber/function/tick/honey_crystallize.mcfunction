...
execute as @e[tag=heartrobber_honeyCrystallize,scores={heartrobber_crystallizeTick=80..}] at @s run item modify entity @s container.0 {function:set_count,add:true,count:-1}
execute as @e[tag=heartrobber_honeyCrystallize,scores={heartrobber_crystallizeTick=80..}] at @s run scoreboard players reset @s heartrobber_crystallizeTick
