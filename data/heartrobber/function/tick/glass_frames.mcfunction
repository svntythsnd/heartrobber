...
execute as @e[type=marker,tag=heartrobber_glass_frame] at @s unless entity @n[type=item_frame,distance=..0.01] run function heartrobber:triggered/glass_frames/normal
execute as @e[type=marker,tag=heartrobber_glow_glass_frame] at @s unless entity @n[type=glow_item_frame,distance=..0.01] run function heartrobber:triggered/glass_frames/glow