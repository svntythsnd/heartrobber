execute as @s[tag=!pot_marker_flower,scores={enhanced_pots.item_count=1}] if items block ~ ~ ~ container.0 #enhanced_pots:plantable/tall run function enhanced_pots:flowers/setup_tall_flower with entity @s data.item
execute as @s[tag=!pot_marker_flower,scores={enhanced_pots.item_count=1}] if items block ~ ~ ~ container.0 #enhanced_pots:plantable/small run function enhanced_pots:flowers/setup_small_flower with entity @s data.item
